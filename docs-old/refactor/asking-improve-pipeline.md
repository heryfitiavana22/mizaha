# demande de modification totale du pipeline

ok c'est parfait.
actuellement je teste l'app, il y a cette resultat qu'on a eu : http://localhost:3000/searches/aa9a9162-657b-4907-9bb3-812005c4801c
...
- ⁠[ ] apres regarde le pipeline_runs du search qu'on a
- [ ] on a tout le droit totalement de tout changer
- [ ] on peut tout totalement changer les input et les ouputs
- [ ] ce n'est pas grave si tout va casser et changer
- [ ] on ne se contente pas de ce qui existe, on peut les effacer et aussi d'ajouter, changer,...
- [ ] on peut effacer, changer, ajouter tout ce qui existe
...
- avoir une meillure resultat possible
